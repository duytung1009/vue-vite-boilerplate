<template>
  <BaseTemplate title="Vite-TS-Tailwind Starter">
    ...
    <p>
      ...
      <a
        href="https://v3.vuejs.org/api/sfc-tooling.html#ide-support"
...
[Action.updateItem](
  ...
  payload: {
    ...
    <p>
      See
      <code>vite.config.js</code> and
      <code>src/env.d.ts</code> for the
      configuration and
      <code>src/pages/BaseTemplate.vue</code> for usage
      example.
    </p>
    ...
    <p>
      ...
      <a
        href="https://caniuse.com/css-backdrop-filter"
      >
        <em>backdrop-filter</em> CSS property
      </a>. The included
      <code>tailwind.config.js</code> has a custom plugin that
      allows you to use a
      <strong>'firefox' variant</strong> in your Tailwind
    ...
    <p>
      Here's an example markup for a div that has a different background opacity
      for FireFox:
    </p>
...
&lt;/div&gt;</pre>
    ...
    <p>
      ...
      area, code coverage is not yet added to this template.
    </p>
    ...
    <p>
      ...
      <a
        href="https://gitlab.com/uninen/vue-cli-template"
      >https://gitlab.com/uninen/vue-cli-template</a>. That's a real world example of proper coverage configuration that works
    ...
    <p>
      ...
      which has decided
      <a
        href="https://github.com/evanw/esbuild/issues/184"
      >code coverage being out of scope</a>. There's a
      <a
        href="https://github.com/vitejs/vite/issues/1955"
      >ticket tracking proper Jest integration w/ Vite</a>
    ...
    <ul>
      ...
      <li>
        ...
        <a
          href="https://til.unessa.net/"
        >Today I Learned</a> site
      </li>
    </ul>
